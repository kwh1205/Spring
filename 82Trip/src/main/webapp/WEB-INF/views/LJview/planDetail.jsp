...
<title>플래너 상세 목록</title>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.planD-imgbox').children('img').attr('src', '${pageContext.request.contextPath}/image/myPlanner/tour/tour' + randomNum + '.jpg');
        ...
        <div class="planD-planbox">
            ...
            <div class="planD-titlebox">
                <div class="planD-imgbox">
                    <img src="${pageContext.request.contextPath}/image/myPlanner/tour/tour1.jpg" class="planD-imgbox--img__big">
