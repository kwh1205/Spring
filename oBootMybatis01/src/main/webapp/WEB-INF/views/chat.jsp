...
<script type="text/javascript">
	...
	function wsOpen(){//처음 이름등록한후 여기실행
		console.log("wsOpen  location.host: " + location.host);
        var wsUri  = "ws://" + location.host + "/oBootMybatis01/chating";//여기 채팅이라고했으면 - 컨트롤러가아닌 컨피그파일에서 실행하게됨 가로챔
        // WebSocket 프로토콜을 사용하여 통신하기 위해서는 WebSocket객체를 생성. 
        // 객체는 자동으로 서버로의 연결
 		ws = new WebSocket(wsUri); //웹소켓 연결 소켓핸들러호출
		wsEvt();//이벤트 호출
	}
